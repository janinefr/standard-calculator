...
function displayNum(){ //att o conteudo dos elementos html que exibem os operandos e a operacao atual
    currentOperandText.innerText = currentOperand.toLocaleString("en"); //formata o numero
